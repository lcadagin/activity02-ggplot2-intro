...
**Response**: The penguin species with the largest distribution of
flipper lengths is Gentoo, with a median flipper length of about 216 mm.
This is followed by the Chinstrap species with a median flipper lenght
of about 197 mm. The smallest distribution of lipper lenghts is Adelle,
with a median flipper length of about 190 mm.
...
**Response**: In the boxplot you can easily determine Quartile
statistics and outliers. In the jitterplot you can easily identify
patterns and groupings of datapoints.
...
**Response**: I would state that the species of the penguin is the
catagorical variable that is contributing more to these two peaks. This
is because the Adelle distribution is centered around about 39 mm while
the Gentoo Distribution is centered around 47 mm and the Chinstrap
population is centered around 49 mm.
...
**Response**: I see a positive coorilation between flipper length (mm)
and body mass (g) of the penguins. That is to say, as flipper lenght
increases, body mass also increases, on average.
...
**Response**: I notice that Gentoo penguins start have larger flipper
lenghts on average than the other two species and body mass appears to
increase at a faster rate when flipper lenght increases, on average.
...
**Response**: I chose and alpha of .5 to show that there are some points
plotted on top of others. I also used slightly large points so they are
more easily viewed.
